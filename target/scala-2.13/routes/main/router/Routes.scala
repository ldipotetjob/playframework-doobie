...
class Routes(
  ...
  // @LINE:10
  FootballLeagueController_1: controllers.FootballLeagueController,
  // @LINE:13
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:13
    Assets_0: controllers.Assets
  ) = this(errorHandler, HomeController_2, FootballLeagueController_1, Assets_0, "/")

  def withPrefix(addPrefix: String): Routes = {
    val prefix = play.api.routing.Router.concatPrefix(addPrefix, this.prefix)
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_2, FootballLeagueController_1, Assets_0, prefix)
  }
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """games""", """controllers.FootballLeagueController.footballMatches()"""),
  ...
  // @LINE:10
  private[this] lazy val controllers_FootballLeagueController_footballMatches3_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("games")))
  )
  private[this] lazy val controllers_FootballLeagueController_footballMatches3_invoker = createInvoker(
    FootballLeagueController_1.footballMatches(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.FootballLeagueController",
      "footballMatches",
      Nil,
      "GET",
      this.prefix + """games""",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:10
    case controllers_FootballLeagueController_footballMatches3_route(params@_) =>
      call { 
        controllers_FootballLeagueController_footballMatches3_invoker.call(FootballLeagueController_1.footballMatches())
      }
