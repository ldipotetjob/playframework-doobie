...
package controllers.javascript {
  ...
  // @LINE:10
  class ReverseFootballLeagueController(_prefix: => String) {
    ...
    // @LINE:10
    def footballMatches: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.FootballLeagueController.footballMatches",
      """
        function() {
